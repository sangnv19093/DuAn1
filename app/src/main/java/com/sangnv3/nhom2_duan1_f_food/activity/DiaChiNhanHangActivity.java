...
public class DiaChiNhanHangActivity extends AppCompatActivity {
    ...
    public void showTinhThanhPho(){
        String thanhPho[] = {"Hòa Bình","Phú Thọ","Thái Bình","BẮc Giang","Nam Định","Hà Nội"};
    ...
    public void showQuanHuyen() {
        ...
        if (tinh == 0) {
            ...
            quanHuyen = new String[]{"Tây Hồ", "Hoàn Kiếm", "Hai Bà Trưng", "Đống Đa", "Cầu Giấy"};
        }
    ...
    public void showXaPhuong(){
        ...
        if (tinh == 0) {
            ...
            // Hà Nội
            if(huyen==0){
                xaPhuong = new String[]{"Thụy Khuê","Nhật Tân","Phường Bưởi","Quảng An","Xuân La"};
            } else if (huyen == 1) {
                xaPhuong = new String[]{"Hàng Bồ","Hàng Buồm","Phúc Tân","Đồng Xuân","Hàng Mã"};
            } else if (huyen == 2) {
                xaPhuong = new String[]{"Lê Đại Hành","Minh Khai","Bạch Đằng","Vĩnh Tuy","Cửa Nam"};
            } else if (huyen == 3) {
                xaPhuong = new String[]{"Phương Liên", "Thịnh Quang", "Trung Tự", "Kim Liên", "Khương Thượng"};
            } else if (huyen == 4) {
                xaPhuong = new String[]{"Nghĩa Đô", "Quan Hoa", "Dịch Vọng", "Yên Hòa", "Dịch Vọng Hậu"};
            }
        }
